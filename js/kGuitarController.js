...
KGuitarModule.controller("kGuitarController", ["$scope", "$document", "contextFactory", "loadAssets", "drawingFactory", "$timeout",
    function ($scope, $document, contextFactory, loadAssets, drawingFactory, $timeout) {
        if (!contextFactory) {
